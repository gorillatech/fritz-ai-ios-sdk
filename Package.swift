...
let package = Package(
    ...
    products: [
        ...
        .library(
            ...
            targets: ["FritzCore", "FritzManagedModel", "FritzVisionSegmentationPredictor", "FritzVision", "FritzCoreMLHelpers", "FritzVisionPeopleAndPetAccurate"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "FritzCore",
            path: "Source/FritzCore"),
        .target(
            name: "FritzManagedModel",
            dependencies: ["FritzCore"],
            path: "Source/FritzManagedModel"),
        .target(
            name: "FritzVisionSegmentationPredictor",
